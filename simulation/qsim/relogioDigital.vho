...
ENTITY 	RelogioDigital IS
	...
	load : IN std_logic;
	enable : IN std_logic;
	H1 : OUT STD.STANDARD.bit_vector(6 DOWNTO 0);
	H0 : OUT STD.STANDARD.bit_vector(6 DOWNTO 0);
	M1 : OUT STD.STANDARD.bit_vector(6 DOWNTO 0);
	M0 : OUT STD.STANDARD.bit_vector(6 DOWNTO 0)
	);
END RelogioDigital;
