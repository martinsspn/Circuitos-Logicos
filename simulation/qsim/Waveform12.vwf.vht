...
-- *****************************************************************************
-- Generated on "10/25/2019 15:12:24"
...
SIGNAL t8 : STD_LOGIC;
SIGNAL t9 : STD_LOGIC;
SIGNAL tec : STD_LOGIC_VECTOR(1 DOWNTO 0);
COMPONENT RelogioDigital
	...
	t8 : IN STD_LOGIC;
	t9 : IN STD_LOGIC;
	tec : IN STD_LOGIC_VECTOR(1 DOWNTO 0)
	);
END COMPONENT;
BEGIN
	i1 : RelogioDigital
...
-- tec[1]
t_prcs_tec_1: PROCESS
BEGIN
	tec(1) <= '0';
WAIT;
END PROCESS t_prcs_tec_1;
-- tec[0]
t_prcs_tec_0: PROCESS
BEGIN
	tec(0) <= '0';
WAIT;
END PROCESS t_prcs_tec_0;
