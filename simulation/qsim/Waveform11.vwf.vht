...
-- *****************************************************************************
-- Generated on "10/25/2019 15:06:23"
...
SIGNAL t8 : STD_LOGIC;
SIGNAL t9 : STD_LOGIC;
SIGNAL tc1 : STD_LOGIC_VECTOR(1 DOWNTO 0);
COMPONENT RelogioDigital
	...
	t8 : IN STD_LOGIC;
	t9 : IN STD_LOGIC;
	tc1 : IN STD_LOGIC_VECTOR(1 DOWNTO 0)
	);
END COMPONENT;
BEGIN
	i1 : RelogioDigital
...
-- tc1[1]
t_prcs_tc1_1: PROCESS
BEGIN
	tc1(1) <= '0';
WAIT;
END PROCESS t_prcs_tc1_1;
-- tc1[0]
t_prcs_tc1_0: PROCESS
BEGIN
	tc1(0) <= '0';
WAIT;
END PROCESS t_prcs_tc1_0;
